...
public class CommonTitle extends RelativeLayout {
    ...
    public static final int TITLE_TEXT = cn.dlc.commonlibrary.R.id.titleText;
    public static final int LEFT_IMAGE = cn.dlc.commonlibrary.R.id.leftImage;
    public static final int RIGHT_IMAGE = cn.dlc.commonlibrary.R.id.rightImage;
    public static final int LEFT_TEXT = cn.dlc.commonlibrary.R.id.leftText;
    public static final int RIGHT_TEXT = cn.dlc.commonlibrary.R.id.rightText;
    private static final int STATUS_HOLDER = cn.dlc.commonlibrary.R.id.statusHolder;
    ...
    public CommonTitle(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        View view = LayoutInflater.from(context)
                .inflate(R.layout.view_common_title, this, true);
        ...
        bottomLine = view.findViewById(cn.dlc.commonlibrary.R.id.bottomLine);
